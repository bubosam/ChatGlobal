...
public class Login_Activity_Connect extends AppCompatActivity {
         ...
         //   forpass = (Button)findViewById(R.id.forgotpass);
            ...
            register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent regactivity = new Intent(Login_Activity_Connect.this,RegistrationActivity.class);
            ...
            login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    JSONObject json = sr.getJSON("http://10.0.2.2:1337/login",params);
                    if(json != null){
                        try{
                            ...
                            if(json.getBoolean("res")){
                                ...
                                edit.commit();
                                Intent profactivity = new Intent(Login_Activity_Connect.this,ChatActivity.class);
            ...
            forpass.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View view) {
                    reset = new Dialog(Login_Activity_Connect.this);
